...
const Navbar = () => {
  ...
  return (
    <header 
      className={cn(
        "fixed top-2 left-0 right-0 z-50 transition-all duration-300 flex flex-col", // Changed from top-1 to top-2
        scrolled 
    ...
    >
      ...
      <div className="container mx-auto px-4 flex justify-between items-center h-16"> {/* Increased height from default to h-16 */}
        <a 
          href="#" 
